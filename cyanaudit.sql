...
begin
    ...
    -- TODO: improve next statement
    begin
        select pg_get_constraintdef(oid)
        into my_constraint_src
        from pg_constraint
        WHERE contype IN ('f', 'p ')
        AND connamespace = 'cyanaudit'::regnamespace  -- schema here
        AND conrelid=in_table_name::regclass -- table here
        AND conname=my_constraint_name;
    exception when others then
        my_constraint_src := NULL;
    end;
